          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/yuliiak111/SwiftChat.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                  </div>
            </header>
            <div className="body">
              <h3>SwiftUI + Firebase Chatting</h3>
              <p> This app can be used for realtime one to one chatting data is stored in firebase database. Supports sharing of images as well.</p>
            </div>
            <footer> <ul className="tech-list"> <li>Swift UI</li> <li>Firebase</li> <li>APN</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/yuliiak111/Flutter_Ecommerce" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Flutter E-Commerce App Template</h3>
              <p>
